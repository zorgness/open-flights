...
const ReviewForm = (props) => {
    const ratingOptions = [5,4,3,2,1].map((score, index) => {
        ...
        return (
            <Fragment key={index}>
                <input type="radio" value={score} checked={props.review.score == score} name="rating" id={`selected-${score}`} onChange={() => console.log(score)} />
                <label onClick={props.setRating.bind(ReviewForm, score)}></label>
             </Fragment>
